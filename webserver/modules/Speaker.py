...
"""
    ...
    - The conversation so far: {self.message_store}.
"""
                )
    ...
    The conversation so far: {self.message_store}. Please return information in metric format.  
    ...
    """)
            ...
            Try to keep response in one sentence. Please return information in metric format. 
            The conversation so far: {self.message_store}.
            The current time is" {current_time}, only relay this if it is relevant to the user's request.
    ...
    def check_chat_status(self, chat_status):
        """Checks if a new conversation has been started.

        Parameters:
        - chat_status (str): bool wrapped in str representing if a new conversation has started.
        """
        if chat_status == "true":
            self.message_store = []
            self.spoken_to_before = False
